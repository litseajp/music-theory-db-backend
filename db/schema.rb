...
ActiveRecord::Schema[7.1].define(version: 2023_11_05_143136) do
  create_table "constant_accidentals", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "constant_scale_tones", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.bigint "accidental_id"
    t.bigint "interval_id"
    t.bigint "tone_type_id"
    t.index ["accidental_id"], name: "index_constant_scale_tones_on_accidental_id"
  ...
  add_foreign_key "constant_scale_tones", "constant_accidentals", column: "accidental_id"
